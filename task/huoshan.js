...
if ($.isNode()) {
    console.log(`环境变量HSURL` + process.env.HSURL)
    console.log(`环境变量HSHEADER` + process.env.HSHEADER)
    console.log(`环境变量HSBODY` + process.env.HSBODY)
    console.log(`环境变量PLAYURL` + process.env.PLAYURL)
    console.log(`环境变量PLAYHEADER` + process.env.PLAYHEADER)
    console.log(`环境变量PLAYBODY` + process.env.PLAYBODY)
